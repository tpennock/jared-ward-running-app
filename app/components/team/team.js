    ...
    controller: function JwrTeamCtrl($log) {
        ...
        $team.members = [
            ...
            },
            {
                name: 'Taylor Pennock',
                role: 'Webmaster',
                image: 'img/jwrc/team/p3.jpg',
                blurb: '',
                bio: '<p>Taylor is a software engineer and technology enthusiast with extensive experience building rich web applications and services that emphasize modern design elements and user interactivity. He has demonstrated expertise in creating web solutions to enhance business processes, improving user experience with client-side web technologies, and implementing design concepts with pixel-perfect accuracy.</p>' +
                     '<p>After graduating from the Eccles School of Business with a degree in Information Systems, Taylor worked at a couple of Utah tech startups. Currently Taylor works at Vivint as a software engineering manager. When not at work, Taylor enjoys soccer and his family.</p>' +
                     '<p>Though not a competitive runner, like Jared, Taylor enjoys getting up and running before work. He is also among the first to sign up for any friendly office challenges.</p>',
                social: [
                    {
                        icon: 'fa-linkedin',
